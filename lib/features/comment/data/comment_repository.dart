...
class CommentRepository implements BaseRepository<Comment> {
  ...
  @override
  /// Returns all cached comments from local storage.
  ///
  ...
  ValueListenable<Box<Comment>> listenableBox() {
  ...
  List<Comment> getAllFromBox(Box<Comment> box) {
    return box.values.toList().cast<Comment>();
  }
  ...
  Future<void> hardRefresh() async {
    try {
      ...
      debugPrint("Comment refresh failed: $e");
    }
  }
}
